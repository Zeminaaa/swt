...
class Kniha():
    def __init__(self,nazev, autor,rok_vydani,id = None, pujcena=False):
        self.nazev = nazev
        self.autor = autor
        self.rok_vydani = rok_vydani
        self.id = id
        self.pujcena=pujcena
        self.format=None
    ...
    def __eq__(self, value):
        if self.nazev == value.nazev and self.autor == value.autor and self.rok_vydani==value.rok_vydani:
            return True
        else:
            return False
    ...
    def je_pujcena_otaznik(self):
        if self.pujcena==True:
            print("tato kniha je pujcena")
        else:
            print("tato kniha neni pujcena")
...
print(mojekniha.get_id())

if mojekniha == mojekniha3:
    print("stejne")
for kniha in [mojekniha,mojekniha2]:
    kniha.popis()



mojekniha.pujc_knihu()
mojekniha.vrat_knihu()
mojekniha.je_pujcena_otaznik()
mojekniha3.je_pujcena_otaznik()

zk = Knihovna()

zk.pridej_knihu(Kniha("špalíček pohádek","František Vodvářka", 1808))
zk.pridej_knihu(mojekniha2)
zk.pridej_knihu(mojekniha3)
#zk.seznam_knih()
